...
@section('main-content')
                  ...
                  <tr class="topRow">
                    ...
                    <td align='center'>
                      @if($eos->status === 0 || $eos->status === 3)
                        <a href="javascript:undefined;" class="fa fa-fw fa-trash" style="text-decoration: none;" data-delete-element="div" data-delete-url="{{ URL::route('request.destroy', $eos['id']) }}"></a>
                      @endif
                    </td>
                    </tr>
                    <tr class="hackAttack">
 ...
 <script>
 // btn btn-small btn-danger confirm-dialog-btn-confirm
 // $('.confirm-dialog-btn-confirm').click(function(e){
 //
 //   console.log('workin');
 // })
